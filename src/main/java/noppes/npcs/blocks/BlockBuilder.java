...
public class BlockBuilder extends BlockContainer implements IPermission {
   ...
   public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase entity, ItemStack stack) {
      ...
      world.setBlockState(pos, state.withProperty(ROTATION, Integer.valueOf(var6)), 2);
   ...
   public boolean isAllowed(EnumPacketServer e) {
      return e == EnumPacketServer.SchematicsSet || e == EnumPacketServer.SchematicsTile || e == EnumPacketServer.SchematicsTileSave;
   }
