...
public class EntityAIFollow extends EntityAIBase {
   ...
   public boolean canExcute() {
      return this.npc.isEntityAlive() && this.npc.isFollower() && !this.npc.isAttacking() && (this.owner = this.npc.getOwner()) != null && this.npc.ai.animationType != 1;
   }
   ...
   public void updateTask() {
      ...
      if(this.updateTick >= 10) {
         ...
         double distance = this.npc.getDistanceSqToEntity(this.owner);
