...
public class DataRanged implements INPCRanged {
   ...
   private boolean pRender3D = false;
   ...
   private String fireSound = "random.bow";
   private String hitSound = "random.bowhit";
   private String groundSound = "random.break";
   ...
   public int getDelayRNG() {
      ...
      if(this.maxDelay - this.minDelay > 0) {
         delay += this.npc.worldObj.rand.nextInt(this.maxDelay - this.minDelay);
      }
