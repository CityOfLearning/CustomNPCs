	...
	public static String Translate(String text) {
		try {
			String urlStr = String.format(
					"http://translate.google.com/translate_a/t?client=t&text=%s&hl=en&sl=%s&tl=%s&ie=UTF-8&oe=UTF-8&multires=1&otf=1&pc=1&trs=1&ssel=3&tsel=6&sc=1",
					URLEncoder.encode(text, "utf8"), "auto", "nl");
