...
public class ClientProxy extends CommonProxy {
	...
	public void load() {
		...
		blockIgnoreBlockstate(CustomItems.couchWood, new IProperty[] { BlockRotated.DAMAGE });
		blockIgnoreBlockstate(CustomItems.couchWool, new IProperty[] { BlockRotated.DAMAGE });
