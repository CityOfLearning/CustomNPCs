...
public class GuiNpcFollowerSetup extends GuiContainerNPCInterface2 {
	...
	public void initGui() {
		...
		addTextField(
				new GuiNpcTextField(3, this, fontRendererObj, guiLeft + 100, guiTop + 6, 286, 20, role.dialogHire));
		addTextField(new GuiNpcTextField(4, this, fontRendererObj, guiLeft + 100, guiTop + 30, 286, 20,
				role.dialogFarewell));
