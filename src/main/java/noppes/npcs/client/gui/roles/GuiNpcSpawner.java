...
public class GuiNpcSpawner extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
	...
	public GuiNpcSpawner(EntityNPCInterface npc) {
		...
		title2 = "gui.selectnpc";
		title3 = "gui.selectnpc";
		title4 = "gui.selectnpc";
		title5 = "gui.selectnpc";
		title6 = "gui.selectnpc";
	...
	public void initGui() {
		super.initGui();
		int y = guiTop + 6;
		addButton(new GuiNpcButton(20, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(0, "1:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(0, guiLeft + 50, y, title1));
		y += 23;
		addButton(new GuiNpcButton(21, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(1, "2:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(1, guiLeft + 50, y, title2));
		y += 23;
		addButton(new GuiNpcButton(22, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(2, "3:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(2, guiLeft + 50, y, title3));
		y += 23;
		addButton(new GuiNpcButton(23, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(3, "4:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(3, guiLeft + 50, y, title4));
		y += 23;
		addButton(new GuiNpcButton(24, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(4, "5:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(4, guiLeft + 50, y, title5));
		y += 23;
		addButton(new GuiNpcButton(25, guiLeft + 25, y, 20, 20, "X"));
		addLabel(new GuiNpcLabel(5, "6:", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(5, guiLeft + 50, y, title6));
		y += 23;
		addLabel(new GuiNpcLabel(6, "spawner.diesafter", guiLeft + 4, y + 5));
		addButton(new GuiNpcButton(26, guiLeft + 115, y, 40, 20, new String[] { "gui.yes", "gui.no" },
				job.doesntDie ? 1 : 0));
		addLabel(new GuiNpcLabel(11, "spawner.despawn", guiLeft + 170, y + 5));
		addButton(new GuiNpcButton(11, guiLeft + 335, y, 40, 20, new String[] { "gui.no", "gui.yes" },
				job.despawnOnTargetLost ? 1 : 0));
		y += 23;
		...
		addButton(new GuiNpcButton(10, guiLeft + 80, y, 100, 20,
				new String[] { "spawner.one", "spawner.all", "spawner.random" }, job.spawnType));
	}
