...
public class GuiNpcItemGiver extends GuiContainerNPCInterface2 {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(0, this, this.fontRendererObj, this.guiLeft + 55, this.guiTop + 54, 90, 20, this.role.cooldown + ""));
      ...
      for(Iterator var2 = this.role.lines.iterator(); var2.hasNext(); ++i) {
         ...
         this.addTextField(new GuiNpcTextField(i + 1, this, this.fontRendererObj, this.guiLeft + 150, this.guiTop + 6 + i * 24, 236, 20, line));
      }

      while(i < 3) {
         this.addTextField(new GuiNpcTextField(i + 1, this, this.fontRendererObj, this.guiLeft + 150, this.guiTop + 6 + i * 24, 236, 20, ""));
         ++i;
      }
