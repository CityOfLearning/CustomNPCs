...
public class GuiNpcItemGiver extends GuiContainerNPCInterface2 {
	...
	public void initGui() {
		super.initGui();
		addButton(new GuiNpcButton(0, guiLeft + 6, guiTop + 6, 140, 20, new String[] { "Random Item", "All Items",
				"Give Not Owned Items", "Give When Doesnt Own Any", "Chained" }, role.givingMethod));
		addButton(new GuiNpcButton(1, guiLeft + 6, guiTop + 29, 140, 20,
				new String[] { "Timer", "Give Only Once", "Daily" }, role.cooldownType));
		addTextField(
				new GuiNpcTextField(0, this, fontRendererObj, guiLeft + 55, guiTop + 54, 90, 20, role.cooldown + ""));
