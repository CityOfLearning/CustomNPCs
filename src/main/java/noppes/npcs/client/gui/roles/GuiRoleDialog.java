...
public class GuiRoleDialog extends GuiNPCInterface2 implements ISubGuiListener {
   ...
   public void initGui() {
      ...
      for(int i = 1; i <= 6; ++i) {
         ...
         String text = (String)this.role.options.get(Integer.valueOf(i));
         if(text == null) {
            text = "";
         }
   ...
   protected void actionPerformed(GuiButton guibutton) {
      if(guibutton.id <= 6) {
         ...
         if(this.slot >= 1) {
            text = (String)this.role.optionsTexts.get(Integer.valueOf(this.slot));
         }
   ...
   public void save() {
      ...
      for(int i = 1; i <= 6; ++i) {
         ...
         if(!text.isEmpty()) {
            map.put(Integer.valueOf(i), text);
         }
      }
   ...
   public void subGuiClosed(SubGuiInterface subgui) {
      if(subgui instanceof SubGuiNpcTextArea) {
         ...
         if(this.slot == 0) {
            ...
            this.role.optionsTexts.put(Integer.valueOf(this.slot), text.text);
         }
      }
