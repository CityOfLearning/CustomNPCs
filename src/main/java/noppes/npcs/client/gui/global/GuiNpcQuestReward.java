...
public class GuiNpcQuestReward extends GuiContainerNPCInterface implements ITextfieldListener {
	...
	public void initGui() {
		...
		addButton(new GuiNpcButton(0, guiLeft + 4, guiTop + 14, 60, 20, new String[] { "gui.no", "gui.yes" },
				quest.randomReward ? 1 : 0));
		addButton(new GuiNpcButton(5, guiLeft, guiTop + ySize, 98, 20, "gui.back"));
		addLabel(new GuiNpcLabel(1, "quest.exp", guiLeft + 4, guiTop + 45));
		addTextField(
				new GuiNpcTextField(0, this, fontRendererObj, guiLeft + 4, guiTop + 55, 60, 20, quest.rewardExp + ""));
