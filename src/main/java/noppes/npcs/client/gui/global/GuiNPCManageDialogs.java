...
public class GuiNPCManageDialogs extends GuiNPCInterface2 implements IScrollData, ISubGuiListener, GuiSelectionListener,
	...
	public void buttonEvent(GuiButton guibutton) {
		...
		if ((id == 9) && (dialog.id >= 0)) {
			NoppesUtil.openGUI(player, gui = new GuiNpcSoundSelection(this, getTextField(2).getText()));
		}
		if (id == 10) {
	...
	private void dialogGuiInit() {
		...
		addTextField(new GuiNpcTextField(1, this, fontRendererObj, guiLeft + 36, guiTop + 3, 140, 20, dialog.title));
		...
		addButton(new GuiNpcButton(10, guiLeft + 4, guiTop + 172, 120, 20, "gui.extraoptions"));
	}
