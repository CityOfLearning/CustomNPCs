...
public class SubGuiNpcMovement extends SubGuiInterface implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      y += 22;
      var10001.<init>(15, var10004, y, 100, 20, new String[]{"movement.ground", "movement.flying"}, this.ai.movementType);
      this.addButton(var10001);
      GuiNpcTextField var2;
      int var10005;
      if(this.ai.getMovingType() == 1) {
         var2 = new GuiNpcTextField;
         var10005 = this.guiLeft + 100;
         y += 22;
         var2.<init>(4, this, var10005, y, 40, 20, this.ai.walkingRange + "");
         this.addTextField(var2);
         ...
         y += 22;
         var10001.<init>(5, var10004, y, 50, 20, new String[]{"gui.no", "gui.yes"}, this.ai.npcInteracting?1:0);
         this.addButton(var10001);
         ...
         y += 22;
         var2.<init>(7, this, var10005, y, 24, 20, (int)this.ai.bodyOffsetX + "");
         this.addTextField(var2);
         ...
         y += 22;
         var10001.<init>(3, var10004, y, 100, 20, new String[]{"stats.normal", "movement.sitting", "movement.lying", "movement.sneaking", "movement.dancing", "movement.aiming", "movement.crawling", "movement.hug"}, this.ai.animationType);
         this.addButton(var10001);
         ...
         if(this.ai.animationType != 2) {
            ...
            var10004 = this.guiLeft + 80;
            y += 22;
            var10001.<init>(4, var10004, y, 80, 20, new String[]{"movement.body", "movement.manual", "movement.stalking", "movement.head"}, this.ai.getStandingType());
            this.addButton(var10001);
            ...
            var10005 = this.guiLeft + 99;
            y += 22;
            var2.<init>(5, this, var10005, y, 40, 20, this.ai.orientation + "");
            this.addTextField(var2);
      ...
      if(this.ai.getMovingType() != 0) {
         ...
         var10004 = this.guiLeft + 80;
         y += 22;
         var10001.<init>(12, var10004, y, 100, 20, new String[]{"stats.normal", "movement.sneaking", "movement.aiming", "movement.dancing", "movement.crawling", "movement.hug"}, EntityAIAnimation.getWalkingAnimationGuiIndex(this.ai.animationType));
         this.addButton(var10001);
      ...
      if(this.ai.getMovingType() == 2) {
         ...
         var10004 = this.guiLeft + 80;
         y += 22;
         var10001.<init>(8, var10004, y, 80, 20, new String[]{"ai.looping", "ai.backtracking"}, this.ai.movingPattern);
         this.addButton(var10001);
         this.addLabel(new GuiNpcLabel(8, "movement.name", this.guiLeft + 4, y + 5));
         var10001 = new GuiNpcButton;
         var10004 = this.guiLeft + 80;
         y += 22;
         var10001.<init>(9, var10004, y, 80, 20, new String[]{"gui.no", "gui.yes"}, this.ai.movingPause?1:0);
         this.addButton(var10001);
      ...
      var10004 = this.guiLeft + 100;
      y += 22;
      var10001.<init>(13, var10004, y, 50, 20, new String[]{"gui.no", "gui.yes"}, this.ai.stopAndInteract?1:0);
      this.addButton(var10001);
      this.addLabel(new GuiNpcLabel(13, "movement.stopinteract", this.guiLeft + 4, y + 5));
      var2 = new GuiNpcTextField;
      var10005 = this.guiLeft + 80;
      y += 22;
      var2.<init>(14, this, var10005, y, 50, 18, this.ai.getWalkingSpeed() + "");
      this.addTextField(var2);
