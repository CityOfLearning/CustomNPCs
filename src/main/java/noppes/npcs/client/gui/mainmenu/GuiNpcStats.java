...
public class GuiNpcStats extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
   ...
   public void initGui() {
      ...
      y += 22;
      var10001.<init>(0, var10004, y, 56, 20, "selectServer.edit");
      ...
      y += 22;
      var10001.<init>(2, var10004, y, 56, 20, "selectServer.edit");
      this.addButton(var10001);
      this.addLabel(new GuiNpcLabel(5, "stats.meleeproperties", this.guiLeft + 5, y + 5));
      var10001 = new GuiNpcButton;
      var10004 = this.guiLeft + 82;
      y += 22;
      var10001.<init>(3, var10004, y, 56, 20, "selectServer.edit");
      this.addButton(var10001);
      ...
      var10004 = this.guiLeft + 82;
      y += 34;
      var10001.<init>(15, var10004, y, 56, 20, "selectServer.edit");
      this.addButton(var10001);
      this.addLabel(new GuiNpcLabel(15, "potion.resistance", this.guiLeft + 5, y + 5));
      var10001 = new GuiNpcButton;
      var10004 = this.guiLeft + 82;
      y += 34;
      var10001.<init>(4, var10004, y, 56, 20, new String[]{"gui.no", "gui.yes"}, this.npc.isImmuneToFire()?1:0);
      this.addButton(var10001);
      ...
      GuiNpcTextField var2 = new GuiNpcTextField;
      int var10005 = this.guiLeft + 355;
      y += 22;
      var2.<init>(16, this, var10005, y, 56, 20, this.stats.combatRegen + "");
      ...
      GuiNpcButtonYesNo var3 = new GuiNpcButtonYesNo;
      var10004 = this.guiLeft + 82;
      y += 22;
      var3.<init>(17, var10004, y, 56, 20, this.stats.potionImmune);
      this.addButton(var3);
