...
public class GuiNPCInv extends GuiContainerNPCInterface2 implements ISliderListener, IGuiData {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(0, this, this.fontRendererObj, this.guiLeft + 108, this.guiTop + 29, 60, 20, this.npc.inventory.getExpMin() + ""));
      ...
      this.addTextField(new GuiNpcTextField(1, this, this.fontRendererObj, this.guiLeft + 108, this.guiTop + 63, 60, 20, this.npc.inventory.getExpMax() + ""));
