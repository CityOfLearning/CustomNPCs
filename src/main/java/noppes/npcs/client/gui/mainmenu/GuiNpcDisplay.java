...
public class GuiNpcDisplay extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(0, this, this.fontRendererObj, this.guiLeft + 50, y, 200, 20, this.display.getName()));
      ...
      this.addTextField(new GuiNpcTextField(11, this, this.fontRendererObj, this.guiLeft + 50, y, 200, 20, this.display.getTitle()));
      y += 23;
      ...
      this.addTextField(new GuiNpcTextField(2, this, this.fontRendererObj, this.guiLeft + 203, y, 40, 20, this.display.getSize() + ""));
      ...
      this.addTextField(new GuiNpcTextField(3, this, this.fontRendererObj, this.guiLeft + 80, y, 200, 20, this.display.skinType == 0?this.display.getSkinTexture():this.display.getSkinUrl()));
      ...
      this.addTextField(new GuiNpcTextField(8, this, this.fontRendererObj, this.guiLeft + 80, y, 200, 20, this.display.getCapeTexture()));
      ...
      this.addTextField(new GuiNpcTextField(9, this, this.fontRendererObj, this.guiLeft + 80, y, 200, 20, this.display.getOverlayTexture()));
      ...
      this.addLabel(new GuiNpcLabel(6, "display.tint", this.guiLeft + 245, y + 5));
      ...
      this.addTextField(new GuiNpcTextField(6, this, this.guiLeft + 350, y, 60, 20, color));
      ...
      this.addButton(new GuiNpcButton(10, this.guiLeft + 120, y, 110, 20, new String[]{"display.hide", "display.show", "display.showAttacking"}, this.display.getBossbar()));
   }
   ...
   protected void actionPerformed(GuiButton guibutton) {
      ...
      if(button.id == 2) {
         ...
         this.display.setHashLivingAnimation(button.getValue() == 0);
      } else if(button.id == 7) {
