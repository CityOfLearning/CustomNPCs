...
public class GuiNpcAI extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
   ...
   public void initGui() {
      ...
      if(this.ai.tacticalVariant != 0 && this.ai.tacticalVariant != 6) {
         ...
         this.addTextField(new GuiNpcTextField(3, this, this.fontRendererObj, this.guiLeft + 380, this.guiTop + 135, 30, 20, this.ai.getTacticalRange() + ""));
   ...
   protected void actionPerformed(GuiButton guibutton) {
      ...
      if(button.id == 0) {
         ...
         this.npc.ai.setAvoidsWater(button.getValue() == 1);
      } else if(button.id == 6) {
