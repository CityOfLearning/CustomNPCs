...
public class GuiNPCScenes extends GuiNPCInterface2 {
   ...
   public void initGui() {
      ...
      for(int i = 0; i < this.scenes.scenes.size(); ++i) {
         ...
         this.addButton(new GuiNpcButton(2 + i * 10, this.guiLeft + 181, y, 50, 20, "Edit"));
      ...
      if(this.scenes.scenes.size() < 6) {
         this.addTextField(new GuiNpcTextField(101, this, this.guiLeft + 4, 160, 190, 20, "Scene" + (this.scenes.scenes.size() + 1)));
         this.addButton(new GuiNpcButton(101, this.guiLeft + 204, 160, 60, 20, "gui.add"));
      }
