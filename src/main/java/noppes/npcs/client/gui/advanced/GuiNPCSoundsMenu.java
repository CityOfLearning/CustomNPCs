...
public class GuiNPCSoundsMenu extends GuiNPCInterface2 implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(0, this, this.fontRendererObj, this.guiLeft + 80, this.guiTop + 15, 200, 20, this.npc.advanced.getSound(0)));
      ...
      this.addTextField(new GuiNpcTextField(2, this, this.fontRendererObj, this.guiLeft + 80, this.guiTop + 40, 200, 20, this.npc.advanced.getSound(1)));
      ...
      this.addTextField(new GuiNpcTextField(3, this, this.fontRendererObj, this.guiLeft + 80, this.guiTop + 65, 200, 20, this.npc.advanced.getSound(2)));
      ...
      this.addTextField(new GuiNpcTextField(4, this, this.fontRendererObj, this.guiLeft + 80, this.guiTop + 90, 200, 20, this.npc.advanced.getSound(3)));
      ...
      this.addTextField(new GuiNpcTextField(5, this, this.fontRendererObj, this.guiLeft + 80, this.guiTop + 115, 200, 20, this.npc.advanced.getSound(4)));
   ...
   public void buttonEvent(GuiButton button) {
      if(button.id == 6) {
         ...
         NoppesUtil.openGUI(this.player, this.gui = new GuiNpcSoundSelection(this, this.selectedField.getText()));
      }
