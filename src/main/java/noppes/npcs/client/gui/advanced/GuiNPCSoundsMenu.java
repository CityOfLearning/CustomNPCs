...
public class GuiNPCSoundsMenu extends GuiNPCInterface2 implements ITextfieldListener {
	...
	public void buttonEvent(GuiButton button) {
		if (button.id == 6) {
			...
			NoppesUtil.openGUI(player, gui = new GuiNpcSoundSelection(this, selectedField.getText()));
		}
	}
	...
	public void initGui() {
		...
		addTextField(new GuiNpcTextField(0, this, fontRendererObj, guiLeft + 80, guiTop + 15, 200, 20,
				npc.advanced.getSound(0)));
		...
		addTextField(new GuiNpcTextField(2, this, fontRendererObj, guiLeft + 80, guiTop + 40, 200, 20,
				npc.advanced.getSound(1)));
		...
		addTextField(new GuiNpcTextField(3, this, fontRendererObj, guiLeft + 80, guiTop + 65, 200, 20,
				npc.advanced.getSound(2)));
		...
		addTextField(new GuiNpcTextField(4, this, fontRendererObj, guiLeft + 80, guiTop + 90, 200, 20,
				npc.advanced.getSound(3)));
		...
		addTextField(new GuiNpcTextField(5, this, fontRendererObj, guiLeft + 80, guiTop + 115, 200, 20,
				npc.advanced.getSound(4)));
		...
		addButton(new GuiNpcButton(6, guiLeft + 120, guiTop + 145, 80, 20, new String[] { "gui.no", "gui.yes" },
				npc.advanced.disablePitch ? 0 : 1));
	}
