...
public class SubGuiNpcAvailabilityDialog extends SubGuiInterface implements GuiSelectionListener, IGuiData {
	...
	public void initGui() {
		...
		int y = guiTop + 12;
		addButton(new GuiNpcButton(0, guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				availabitily.dialogAvailable.ordinal()));
		addButton(new GuiNpcButton(10, guiLeft + 56, y, 172, 20, "availability.selectdialog"));
		getButton(10).setEnabled(availabitily.dialogAvailable != EnumAvailabilityDialog.Always);
		addButton(new GuiNpcButton(20, guiLeft + 230, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(1, guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				availabitily.dialog2Available.ordinal()));
		addButton(new GuiNpcButton(11, guiLeft + 56, y, 172, 20, "availability.selectdialog"));
		getButton(11).setEnabled(availabitily.dialog2Available != EnumAvailabilityDialog.Always);
		addButton(new GuiNpcButton(21, guiLeft + 230, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(2, guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				availabitily.dialog3Available.ordinal()));
		addButton(new GuiNpcButton(12, guiLeft + 56, y, 172, 20, "availability.selectdialog"));
		getButton(12).setEnabled(availabitily.dialog3Available != EnumAvailabilityDialog.Always);
		addButton(new GuiNpcButton(22, guiLeft + 230, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(3, guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				availabitily.dialog4Available.ordinal()));
		addButton(new GuiNpcButton(13, guiLeft + 56, y, 172, 20, "availability.selectdialog"));
		getButton(13).setEnabled(availabitily.dialog4Available != EnumAvailabilityDialog.Always);
		addButton(new GuiNpcButton(23, guiLeft + 230, y, 20, 20, "X"));
