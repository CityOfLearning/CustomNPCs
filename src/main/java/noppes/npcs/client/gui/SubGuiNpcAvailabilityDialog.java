...
public class SubGuiNpcAvailabilityDialog extends SubGuiInterface implements GuiSelectionListener, IGuiData {
   ...
   protected void actionPerformed(GuiButton guibutton) {
      ...
      if(button.id == 10) {
         this.slot = 1;
         gui = new GuiNPCDialogSelection(this.npc, this.getParent(), this.availabitily.dialogId);
         gui.listener = this;
      ...
      if(button.id == 11) {
         this.slot = 2;
         gui = new GuiNPCDialogSelection(this.npc, this.getParent(), this.availabitily.dialog2Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
      ...
      if(button.id == 12) {
         this.slot = 3;
         gui = new GuiNPCDialogSelection(this.npc, this.getParent(), this.availabitily.dialog3Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
      ...
      if(button.id == 13) {
         this.slot = 4;
         gui = new GuiNPCDialogSelection(this.npc, this.getParent(), this.availabitily.dialog4Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
