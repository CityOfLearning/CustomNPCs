      ...
      for(int slot = 0; slot < 18; ++slot) {
         ...
         if(item != null && sold != null) {
            ...
            if(item2 != null) {
               ...
               this.itemRender.renderItemOverlays(this.fontRendererObj, item2, x, y + 1);
            }

            this.itemRender.renderItemAndEffectIntoGUI(item, x + 18, y + 1);
            this.itemRender.renderItemOverlays(this.fontRendererObj, item, x + 18, y + 1);
         ...
         if(item != null && sold != null) {
            if(this.isPointInRegion(x + 43, y + 1, 16, 16, par1, par2)) {
               ...
               if(!this.container.canBuy(item, item2, this.player)) {
                  ...
                  this.fontRendererObj.drawString(title, (this.xSize - this.fontRendererObj.getStringWidth(title)) / 2, 131, '\udd00');
               }
            }
