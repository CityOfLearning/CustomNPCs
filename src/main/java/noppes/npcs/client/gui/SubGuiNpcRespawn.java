...
public class SubGuiNpcRespawn extends SubGuiInterface implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      this.addButton(new GuiNpcButton(0, this.guiLeft + 122, this.guiTop + 30, 60, 20, new String[]{"gui.yes", "gui.day", "gui.night", "gui.no", "stats.naturally"}, this.stats.spawnCycle));
      if(this.stats.respawnTime > 0) {
         ...
         this.addButton(new GuiNpcButton(4, this.guiLeft + 122, this.guiTop + 74, 51, 20, new String[]{"gui.no", "gui.yes"}, this.stats.hideKilledBody?1:0));
      }
