...
public class SubGuiNpcProjectiles extends SubGuiInterface implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(1, this, this.fontRendererObj, this.guiLeft + 45, this.guiTop + 10, 50, 18, this.stats.getStrength() + ""));
      ...
      this.addTextField(new GuiNpcTextField(2, this, this.fontRendererObj, this.guiLeft + 150, this.guiTop + 10, 50, 18, this.stats.getKnockback() + ""));
      ...
      this.addTextField(new GuiNpcTextField(3, this, this.fontRendererObj, this.guiLeft + 45, this.guiTop + 40, 50, 18, this.stats.getSize() + ""));
      ...
      this.addTextField(new GuiNpcTextField(4, this, this.fontRendererObj, this.guiLeft + 45, this.guiTop + 70, 50, 18, this.stats.getSpeed() + ""));
      ...
      if(this.stats.getEffectType() != 0) {
         this.addTextField(new GuiNpcTextField(5, this, this.fontRendererObj, this.guiLeft + 140, this.guiTop + 160, 60, 18, this.stats.getEffectTime() + ""));
