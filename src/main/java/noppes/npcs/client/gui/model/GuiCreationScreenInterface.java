...
public abstract class GuiCreationScreenInterface extends GuiNPCInterface implements ISubGuiListener, ISliderListener {
   ...
   public void drawScreen(int x, int y, float f) {
      ...
      if(entity == null) {
         ...
         EntityUtil.Copy((EntityLivingBase)entity, this.npc);
      }
   ...
   public void save() {
      ...
      Client.sendData(EnumPacketServer.MainmenuDisplaySave, new Object[]{this.npc.display.writeToNBT(new NBTTagCompound())});
      Client.sendData(EnumPacketServer.ModelDataSave, new Object[]{newCompound});
   }
