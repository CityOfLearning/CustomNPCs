...
public class SubGuiNpcAvailabilityQuest extends SubGuiInterface implements GuiSelectionListener, IGuiData {
   ...
   protected void actionPerformed(GuiButton guibutton) {
      ...
      if(button.id == 10) {
         this.slot = 1;
         gui = new GuiNPCQuestSelection(this.npc, this.getParent(), this.availabitily.questId);
         gui.listener = this;
      ...
      if(button.id == 11) {
         this.slot = 2;
         gui = new GuiNPCQuestSelection(this.npc, this.getParent(), this.availabitily.quest2Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
      ...
      if(button.id == 12) {
         this.slot = 3;
         gui = new GuiNPCQuestSelection(this.npc, this.getParent(), this.availabitily.quest3Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
      ...
      if(button.id == 13) {
         this.slot = 4;
         gui = new GuiNPCQuestSelection(this.npc, this.getParent(), this.availabitily.quest4Id);
         gui.listener = this;
         NoppesUtil.openGUI(this.player, gui);
      }
