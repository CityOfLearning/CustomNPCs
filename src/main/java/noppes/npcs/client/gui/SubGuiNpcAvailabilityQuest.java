...
public class SubGuiNpcAvailabilityQuest extends SubGuiInterface implements GuiSelectionListener, IGuiData {
	...
	public void initGui() {
		...
		int y = guiTop + 12;
		addButton(new GuiNpcButton(0, guiLeft + 4, y, 90, 20,
				new String[] { "availability.always", "availability.after", "availability.before",
						"availability.whenactive", "availability.whennotactive" },
				availabitily.questAvailable.ordinal()));
		addButton(new GuiNpcButton(10, guiLeft + 96, y, 192, 20, "availability.selectquest"));
		getButton(10).setEnabled(availabitily.questAvailable != EnumAvailabilityQuest.Always);
		addButton(new GuiNpcButton(20, guiLeft + 290, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(1, guiLeft + 4, y, 90, 20,
				new String[] { "availability.always", "availability.after", "availability.before",
						"availability.whenactive", "availability.whennotactive" },
				availabitily.quest2Available.ordinal()));
		addButton(new GuiNpcButton(11, guiLeft + 96, y, 192, 20, "availability.selectquest"));
		getButton(11).setEnabled(availabitily.quest2Available != EnumAvailabilityQuest.Always);
		addButton(new GuiNpcButton(21, guiLeft + 290, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(2, guiLeft + 4, y, 90, 20,
				new String[] { "availability.always", "availability.after", "availability.before",
						"availability.whenactive", "availability.whennotactive" },
				availabitily.quest3Available.ordinal()));
		addButton(new GuiNpcButton(12, guiLeft + 96, y, 192, 20, "availability.selectquest"));
		getButton(12).setEnabled(availabitily.quest3Available != EnumAvailabilityQuest.Always);
		addButton(new GuiNpcButton(22, guiLeft + 290, y, 20, 20, "X"));
		y += 23;
		addButton(new GuiNpcButton(3, guiLeft + 4, y, 90, 20,
				new String[] { "availability.always", "availability.after", "availability.before",
						"availability.whenactive", "availability.whennotactive" },
				availabitily.quest4Available.ordinal()));
		addButton(new GuiNpcButton(13, guiLeft + 96, y, 192, 20, "availability.selectquest"));
		getButton(13).setEnabled(availabitily.quest4Available != EnumAvailabilityQuest.Always);
		addButton(new GuiNpcButton(23, guiLeft + 290, y, 20, 20, "X"));
