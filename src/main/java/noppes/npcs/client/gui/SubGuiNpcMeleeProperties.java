...
public class SubGuiNpcMeleeProperties extends SubGuiInterface implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      this.addTextField(new GuiNpcTextField(1, this, this.fontRendererObj, this.guiLeft + 85, this.guiTop + 10, 50, 18, this.stats.getStrength() + ""));
      ...
      this.addTextField(new GuiNpcTextField(2, this, this.fontRendererObj, this.guiLeft + 85, this.guiTop + 40, 50, 18, this.stats.getRange() + ""));
      ...
      this.addTextField(new GuiNpcTextField(3, this, this.fontRendererObj, this.guiLeft + 85, this.guiTop + 70, 50, 18, this.stats.getDelay() + ""));
      ...
      this.addTextField(new GuiNpcTextField(4, this, this.fontRendererObj, this.guiLeft + 85, this.guiTop + 100, 50, 18, this.stats.getKnockback() + ""));
      ...
      this.addButton(new GuiNpcButton(5, this.guiLeft + 85, this.guiTop + 130, 52, 20, this.potionNames, this.stats.getEffectType()));
      if(this.stats.getEffectType() != 0) {
         this.addLabel(new GuiNpcLabel(6, "gui.time", this.guiLeft + 5, this.guiTop + 165));
         this.addTextField(new GuiNpcTextField(6, this, this.fontRendererObj, this.guiLeft + 85, this.guiTop + 160, 50, 18, this.stats.getEffectTime() + ""));
         ...
         if(this.stats.getEffectType() != 1) {
            ...
            this.addButton(new GuiNpcButton(7, this.guiLeft + 85, this.guiTop + 190, 52, 20, new String[]{"gui.no", "gui.yes"}, this.stats.getEffectStrength()));
         }
      }
