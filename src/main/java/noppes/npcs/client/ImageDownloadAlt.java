            ...
            try {
               ...
               if(connection.getResponseCode() / 100 == 2) {
                  ...
                  if(ImageDownloadAlt.this.cacheFile != null) {
                     ...
                     exception = ImageIO.read(ImageDownloadAlt.this.cacheFile);
                  } else {
                     exception = TextureUtil.readBufferedImage(connection.getInputStream());
                  }

                  if(ImageDownloadAlt.this.imageBuffer != null) {
                     exception = ImageDownloadAlt.this.imageBuffer.parseUserSkin(exception);
                  }

                  ImageDownloadAlt.this.setBufferedImage(exception);
                  return;
               }
