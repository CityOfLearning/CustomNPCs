...
public class Model2DRenderer extends ModelRenderer {
   ...
   private void compileDisplayList(float par1) {
      ...
      renderItemIn2D(Tessellator.getInstance().getWorldRenderer(), this.x1, this.y1, this.x2, this.y2, this.width, this.height, par1);
      GL11.glEndList();
      this.compiled = true;
   }

   public static void renderItemIn2D(WorldRenderer worldrenderer, float p_78439_1_, float p_78439_2_, float p_78439_3_, float p_78439_4_, int p_78439_5_, int p_78439_6_, float p_78439_7_) {
