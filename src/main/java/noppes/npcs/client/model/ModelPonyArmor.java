...
public class ModelPonyArmor extends ModelBase {
	...
	public void setRotationAngles(final float f, final float f1, final float f2, final float f3, final float f4,
		...
		if (isSneak && !isFlying) {
			...
			final ModelRenderer leftArm5 = LeftArm;
