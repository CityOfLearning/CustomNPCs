...
public class ModelCouchWoodRight extends ModelBase {
	...
	public ModelCouchWoodRight() {
		(Shape1 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 3, 10);
		...
		(Shape3 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 1);
		Shape3.setRotationPoint(6.0f, 14.0f, 0.5f);
		(Shape4 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 1);
		Shape4.setRotationPoint(-8.0f, 7.0f, 7.0f);
		(Shape5 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 2);
		Shape5.setRotationPoint(-8.0f, 19.0f, 6.0f);
		(Shape6 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 13);
		...
		(Shape11 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 2);
		...
		(Shape17 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 10, 2);
		Shape17.setRotationPoint(6.0f, 14.0f, -6.0f);
		(Shape18 = new ModelRenderer(this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 18, 2);
