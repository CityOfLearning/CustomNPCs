...
public class LayerLegs extends LayerInterface implements LayerPreRender {
      ...
      if(data != null) {
         ...
         if(data.type == 0) {
            if(data.pattern == 1) {
               ...
               this.tail.rotateAngleY = (float)((double)this.tail.rotateAngleY - 0.2D);
               this.tail.render(par7);
               ++this.tail.rotationPointX;
               this.tail.rotateAngleY = (float)((double)this.tail.rotateAngleY + 0.4D);
               this.tail.render(par7);
   ...
   public void rotateTail(float par1, float par2, float par3, float par4, float par5, float par6) {
      ...
      this.tail.rotateAngleX = this.feathers.rotateAngleX = this.dragon.rotateAngleX = this.squirrel.rotateAngleX = this.horse.rotateAngleX = this.fin.rotateAngleX = this.rodent.rotateAngleX = rotateAngleX;
      this.tail.rotateAngleY = this.feathers.rotateAngleY = this.dragon.rotateAngleY = this.squirrel.rotateAngleY = this.horse.rotateAngleY = this.fin.rotateAngleY = this.rodent.rotateAngleY = rotateAngleY;
   }
