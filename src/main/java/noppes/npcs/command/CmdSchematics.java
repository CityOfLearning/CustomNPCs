...
public class CmdSchematics extends CommandNoppesBase {
   ...
   public void build(ICommandSender sender, String[] args) throws CommandException {
      ...
      if(schem == null) {
         ...
         this.sendMessage(sender, "width: " + schem.width + ", length: " + schem.length + ", height: " + schem.height, new Object[0]);
   ...
   public void list(ICommandSender sender, String[] args) throws CommandException {
      ...
      if(list.isEmpty()) {
         ...
         String file;
         for(Iterator var5 = list.iterator(); var5.hasNext(); s = s + file + ", ") {
            file = (String)var5.next();
         }
